...
export default function NewClubChat() {
  ...
  const clubName = params.clubName ?? "Club";

  const messages = [
    { sender: 'Evelyn', text: 'like this message if ur coming to our meeting tmrw!' },
    { sender: 'Me', text: 'so excited!'},
  ];
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.messagesContainer}>
        ...
        style={[
            ...
            msg.sender === 'Evelyn' ? { alignSelf: 'flex-start'} : { alignSelf: 'flex-end' },
        ]}
        >
        <View
            style={[
