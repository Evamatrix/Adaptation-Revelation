...
const styles = StyleSheet.create({
  ...
  filterText: { fontSize: 16, fontFamily: 'Koulen', color: '#000' },
  ...
  createText: { fontSize: 18, fontFamily: 'Koulen', color: '#000' },
  ...
  clubTitle: { fontSize: 20, fontFamily: 'Koulen', color: '#000' },
  ...
  deleteButton: { backgroundColor: '#FDC9C9' },
  buttonText: { fontFamily: 'Koulen', fontSize: 14, color: '#000' },
